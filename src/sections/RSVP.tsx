...
export default function RSVP() {
    ...
    return (
        <section id="rsvp">
         ...
         <Button className="!bg-primary hover:!bg-secondary/50 !text-white " size="large" variant="contained" target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLSf9ZIxOMC361IIPEtcWIlTC6dDxh72qSUlAZBGSZRDAp2gSKw/viewform?usp=dialog" endIcon={<LaunchIcon />}>
            {t("rsvp.buttonLabel")}
         </Button>
