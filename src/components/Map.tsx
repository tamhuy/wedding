...
export default function Map() {
    ...
    return (
        <section id="venue">
         <h2 className="text-white mb-8">{t("location.title")}</h2>
         <div className="grid lg:grid-cols-6 gap-16 grid-cols-1 text-white">
           {/* Left column - Map */}
           ...
           <div className="col-span-3">
             <h2 className="text-2xl tracking-normal mb-4">{t("location.name")}</h2>
