  ...
  const renderToolbarContent = () => (
    <>
      ...
      <div className="flex items-center absolute right-0 mr-4">
        <Button className="block lg:!hidden !bg-primary/70 hover:!bg-primary/50 " sx={{margin: '0 1.5rem'}} variant="contained" onClick={() => scrollToSection('rsvp')}>{t('header.rsvp')}</Button>
        <LanguageDropdown />
